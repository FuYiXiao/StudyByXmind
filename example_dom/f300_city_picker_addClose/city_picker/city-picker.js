    ...
    CityPicker.prototype = {
        ...
        render: function() {
            var p = this.getPosition(),
                ...
                '<span class="title"></span><span class="closebtn" title="关闭" >X</span><div class="arrow"></div>' + '</span>',
        ...
        bind: function() {
            ...
            this.$textspan.on("click",'.closebtn',function(eve){
                $this.reset();
                eve.stopPropagation();
                eve.preventDefault();
            });
        ...
        feedText: function() {
            ...
            if (text) {
                ...
                this.$textspan.find('>.closebtn').show();
                this.$textspan.find('>.title').html(this.getText()).show();
            } else {
                this.$textspan.find('>.placeholder').text(this.getPlaceHolder()).show();
                this.$textspan.find('>.closebtn').hide();
