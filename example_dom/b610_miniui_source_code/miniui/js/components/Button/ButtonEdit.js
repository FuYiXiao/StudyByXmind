...
mini.extend(mini.ButtonEdit, mini.ValidatorBase, {
    ...
    setShowToolTip: function(value){
        ...
        // 这里为ButtonEidt增加文本提示功能，当文本框中内容超长时提升用户体验。殷文旭 时间 2012-11-08
        if (this.showToolTip)
    ...
    __OnMouseDown: function (e) {
        ...
        if (!mini.isAncestor(this._textEl, e.target)) {
            ...
            var sf = this;
            //1、下面代码中的selectRange不知道干嘛用的，focus方法造成点击图标时也会触发text的focus而触发validata pzf 2014-09
            //2、问题1修改后导致点击图标也会触发validate方法，还原 pzf 2015-02
            //3、问题1其实是合理的，无需处理。
            setTimeout(function () {
                sf.focus();
