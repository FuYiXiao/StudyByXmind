...
mini_CellValidator_Prototype = {
    ...
    validateEditors:function(){
        ...
        for (var i = 0, l = data.length; i < l; i++) {
            ...
            for (var i = 0, l = columns.length; i < l; i++) {
                var column = columns[i];
                var editor = this.getCellEditor(column,row);
                if(editor)
                    editor.validate();
            }
...
mini.DataGrid_Print.prototype = {
    ...
    _createHead: function () {
        ...
        this.$printHeadTable = $(id).children(":first").clone();
    ...
    _createBody: function () {
        if (this.grid.isVirtualScroll()){
            return this._createBodyVirtual();
        }else{
    ...
    _removeBodyUnUseable: function () {
        ...
        //this.$printBodyTable.find("td[class~='mini-checkcolumn']").detach();
    ...
    _removeHeanUnUseable: function () {
        ...
        this.$printHeadTable.find("td").each(function () {
            ...
            //删除<div class="mini-grid-cellInner">
            var cell = $(this).children(".mini-grid-cellInner:first");
            var content = cell.html();
            cell.remove();
            $(this).append(content);
            //删除<span class="mini-grid-sortIcon"></span>
            $(this).children(".mini-grid-sortIcon").detach();
        })
